...
app.MapPost("/api/policies/paypremium", (Premium premium) =>
{
        ...
        NotificationManager notifiy = new NotificationManager();
        EmailNotificationService emailSvc=new EmailNotificationService();      
        accountsManager.premiumPaid+=accounts.OnPremiumPaid;
        accountsManager.premiumPaid+= accounts.OnPaymentReceiptGenerated;
        accountsManager.PayPremium(premium);
...
// // Approve claim
// app.MapPost("/api/claims/approve", (int claim) =>
// {
//     InsurancePolicyManager manager = new InsurancePolicyManager();
